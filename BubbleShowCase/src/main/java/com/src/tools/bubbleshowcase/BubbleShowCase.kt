...
class BubbleShowCase(builder: BubbleShowCaseBuilder) {
    ...
    private fun getBackgroundDimLayout(): RelativeLayout {
        ...
        backgroundLayout.setBackgroundColor(Color.parseColor("#77000000"))
    ...
    private fun takeScreenshotOfLayoutView(targetView: View): Bitmap? {
        ...
        val bitmap: Bitmap = Bitmap.createBitmap(
            getBitmapFromView(currentScreenView),
            getXposition(targetView), getYposition(targetView),
    ...
    private fun isTablet(): Boolean =
        mActivity.get()!!.resources.getBoolean(com.src.tools.bubbleshowcase.R.bool.isTablet)
