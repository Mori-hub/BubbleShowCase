...
class BubbleMessageView : ConstraintLayout {
    ...
    private fun getSecurityArrowMargin(): Int = getMargin() + ScreenUtils.dpToPx(2 * widthARROW / 3)
    ...
    private fun drawArrow(
        ...
        drawRhombus(canvas, paint, xPosition, yPosition, ScreenUtils.dpToPx(widthARROW))
    }
